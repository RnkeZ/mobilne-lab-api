...
import com.tvz.mobilnelabapi.model.AuthorityExample.Criteria;
import com.tvz.mobilnelabapi.model.AuthorityExample.Criterion;
...
public class AuthoritySqlProvider {
	...
	public String countByExample(AuthorityExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("tvz.authority");
