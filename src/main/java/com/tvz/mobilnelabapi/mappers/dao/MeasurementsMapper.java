...
public interface MeasurementsMapper {
	 ...
	 * @mbg.generated  Thu Jul 26 22:42:58 CEST 2018
	 */
	@Insert({ "insert into tvz.measurements (ID, Data, ", "DateOfCreation, UserID, ", "Username)",
			"values (#{id,jdbcType=INTEGER}, #{data,jdbcType=NVARCHAR}, ",
			"#{dateofcreation,jdbcType=TIMESTAMP}, #{userid,jdbcType=INTEGER}, ", "#{username,jdbcType=VARCHAR})" })
