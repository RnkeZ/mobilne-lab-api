...
public interface UserMapper {
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Delete({ "delete from [mob].[user]", "where ID = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Insert({ "insert into [mob].[user] (ID, Username, ", "Password, Firstname, ", "Lastname, Email, ",
	...
	@Select({ "select", "ID, Username, Password, Firstname, Lastname, Email, Enabled, LastPasswordResetDate",
			"from [mob].[user]", "where ID = #{id,jdbcType=INTEGER}" })
	@Results({ @Result(column = "ID", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "Username", property = "username", jdbcType = JdbcType.VARCHAR),
			@Result(column = "Password", property = "password", jdbcType = JdbcType.VARCHAR),
			@Result(column = "Firstname", property = "firstname", jdbcType = JdbcType.VARCHAR),
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Update({ "update [mob].[user]", "set Username = #{username,jdbcType=VARCHAR},",
	...
	UserComposite selectByUsernameComposite(String username);
