...
public interface AuthorityMapper {
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Insert({ "insert into mob.Authority (ID, Name)", "values (#{id,jdbcType=INTEGER}, #{name,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Select({ "select", "ID, Name", "from mob.Authority", "where ID = #{id,jdbcType=INTEGER}" })
	@Results({ @Result(column = "ID", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "Name", property = "name", jdbcType = JdbcType.VARCHAR) })
	 ...
	 * @mbg.generated Sat Jul 28 14:10:31 CEST 2018
	 */
	@Update({ "update mob.Authority", "set Name = #{name,jdbcType=VARCHAR}", "where ID = #{id,jdbcType=INTEGER}" })
