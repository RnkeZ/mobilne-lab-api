...
import com.tvz.mobilnelabapi.model.TypeExample.Criteria;
import com.tvz.mobilnelabapi.model.TypeExample.Criterion;
...
public class TypeSqlProvider {
    ...
    public String countByExample(TypeExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mob.Type");
